...
class Stats
{
    ...
    /**
     * Muchas estadisticas para un agente. Lado de Muchos inversedBy, bidireccional
     * @ORM\ManyToOne(targetEntity="Agents", inversedBy="stats")
     * @ORM\JoinColumn(name="id_agent", referencedColumnName="id_agent")
     */
    private $idAgent;

    /**
     * Muchas estadisticas para una subida. Lado de Muchos inversedBy, bidireccional
    ...
    /**
     * Get muchas estadisticas para un agente. Lado de Muchos inversedBy, bidireccional
     */ 
    ...
    /**
     * Set muchas estadisticas para un agente. Lado de Muchos inversedBy, bidireccional
     *
     * @return  self
     */ 
    ...
    /**
     * Get muchas estadisticas para una subida. Lado de Muchos inversedBy, bidireccional
     */ 
    ...
    /**
     * Set muchas estadisticas para una subida. Lado de Muchos inversedBy, bidireccional
     *
     * @return  self
     */ 
